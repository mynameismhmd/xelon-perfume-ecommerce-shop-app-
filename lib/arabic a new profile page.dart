...
class arProfilePage extends StatefulWidget {
  const arProfilePage({Key? key}) : super(key: key);

  @override
  State<arProfilePage> createState() => _arProfilePageState();
}

class _arProfilePageState extends State<arProfilePage> {
  File? _selectedImage;
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text('الملف الشخصي', style: _heading1.copyWith(fontFamily: 'nz')),
                    ...
                    child: Column(
                     ...
                     GestureDetector(
                        ...
                        ElevatedButton(
                          ...
                          child: const Text("الحصول علی موقعك" ,style:TextStyle(fontFamily: 'nz', fontWeight: FontWeight.bold,fontSize: 14)),
                          onPressed: () {
                        ...
                        ElevatedButton(
                          ...
                          child: Text('تعديل الملف الشخصي', style: _buttonText.copyWith(fontFamily: 'nz')),
                        ),
                      ],
                    ),
                  ),
